...
<body>
    ...
    <header>
        ...
        <center><h3 style="margin-bottom:50px;"><span style="font-weight:bold; color: rgb(0, 255, 191)">Update User Data</span></h3></center>
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 box1">
                        ...
                        <input type="submit"  class="btn" name="update" style="font-weight:bold; background-color: rgb(0, 255, 191)" value="Update User Data">
                    </div>
                </div>   
            </form>
        </div>
